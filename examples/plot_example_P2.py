...
print(f'KNORAE score = {knora_e.score(X_test, y_test)}')
print(f'DESP score = {desp.score(X_test, y_test)}')
print(f'OLA score = {ola.score(X_test, y_test)}')
print(f'Rank score = {rank.score(X_test, y_test)}')
print(f'SVM score = {svm.score(X_test, y_test)}')
print(f'MLP score = {mlp.score(X_test, y_test)}')
print(f'RF score = {forest.score(X_test, y_test)}')
print(f'Boosting score = {boosting.score(X_test, y_test)}')
print(f'Stacking LR score = {stacked_lr.score(X_test, y_test)}')
print(f'Staking Decision Tree = {stacked_dt.score(X_test, y_test)}')
